...
export default function HeroCarousel() {
    ...
    return (
        <div className="relative w-full h-screen overflow-hidden bg-black text-white font-sans">
            ...
            {/* CONTENIDO PRINCIPAL */}
            <div className="absolute z-20 top-0 left-0 w-full h-full flex flex-col justify-center px-12 md:px-24">
                ...
                <div className="mt-12 flex items-center gap-4">
                    <div
                        ...
                        className="relative w-16 h-16 flex items-center justify-center rounded-full border border-gray-500 cursor-pointer hover:bg-white/10 transition-colors"
                    >
                        {isPaused ? (
            ...
            {/* MINIATURAS (4 visibles) */}
            <div className="absolute z-30 bottom-12 right-12 flex gap-6">
                {visibleThumbnails.map((slideItem) => (
                    <motion.div
                        ...
                        className="relative w-36 h-48 md:w-40 md:h-56 rounded-xl overflow-hidden cursor-pointer group shadow-2xl border border-white/10"
                    >
                        <img
                            src={slideItem.image}
                            alt={slideItem.title}
